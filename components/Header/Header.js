      ...
      <div className="container  mx-auto">
        <div className="p-2 md:flex w-full items-center">
          <div className="md:w-2/4 h-full ">
            ...
            <div className="my-2 grid grid-cols-3 p-1 justify-center gap-1  mx-auto max-w-full md:mx-0">
                <div>
                  <h1 className="md:text-2xl text-xl font-extrabold">25+</h1>
                  <h1 className="text-xs md:text-lg">Online Courses</h1>
                </div>
                <div>
                <h1 className=" md:text-2xl text-xl font-extrabold">4+</h1>
                  <h1 className="text-xs md:text-lg">Expert Tutors</h1>
                </div>
                <div>
                <h1 className=" md:text-2xl text-xl font-extrabold">75+</h1>
                  <h1 className="text-xs md:text-lg">Online Students</h1>
                </div>
            </div>
          </div>
          <div className="md:w-2/4 h-full">
